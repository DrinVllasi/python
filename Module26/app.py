...
if selected_menu == "Dashboard":
    ...
    if st.button("Add Recipe", key="add_recipe_button"):
        if all([recipe_name,recipe_description,recipe_ingredients,recipe_instructions,recipe_difficulty,recipe_cuisine, selected_category_id is not None]):
            create_recipe(recipe_name,recipe_description,recipe_ingredients,recipe_instructions,recipe_difficulty,recipe_cuisine,selected_category_id)
        ...
        if manage_Action == "Edit":
            ...
            if recipe_to_edit:
                ...
                if st.button("Update Recipe", key="update_recipe_button"):
                    if all([edit_name,edit_instructions,edit_description,edit_ingredients,edit_difficulty,edit_cuisine,edit_category_id is not None]):
                        update_recipe(selected_recipe['id'], edit_name,edit_instructions,edit_description,edit_ingredients,edit_difficulty,edit_cuisine,edit_category_id)
